...
class StockRNN(object):
    ...
    def __init__(self, random_num=3,
                 seq_size=100,
                 input_dimension=6,
                 output_dimension=1,
    ...
    def _get_features(self, input_dimension):
        if input_dimension == 6:
            return ['nav_base', '10VOL', '20VOL', '30VOL', '40VOL', '50VOL']
    ...
    def _data_prepare(self):
        ...
        feature_list = self._get_features(self.input_dimension)
        ...
        print(len(training_data),
              ...
              len(training_data[training_data['diff'] < 0]))
        print(len(test_data),
              len(test_data[test_data['diff'] >= 0]),
              len(test_data[test_data['diff'] < 0]))
        ...
        for code in self.stock_code:
            ...
            train_x = np.asmatrix(df[feature_list])
        ...
        for code in self.stock_code:
            ...
            test_x = np.asmatrix(df[feature_list])
